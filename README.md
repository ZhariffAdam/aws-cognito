...
```php
    ...
    AWS_COGNITO_SIGNIN_ATTRIBUTE="email" //optional - default value is 'email'
    AWS_COGNITO_SIGNIN_PASSWORD_ATTRIBUTE="password" //optional - default value os 'password'

```
The key **AWS_COGNITO_SIGNIN_ATTRIBUTE** permits to configure signin paramters for the application (i.e email address, phone number, username or preferred username)
